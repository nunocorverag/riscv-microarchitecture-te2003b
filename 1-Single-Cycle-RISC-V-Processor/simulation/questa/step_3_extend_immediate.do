...
add wave -noupdate -divider immediate_generator
add wave -noupdate /top_tb/DUT/IMM_GEN/immSrc
add wave -noupdate -radix binary /top_tb/DUT/IMM_GEN/extend_in
add wave -noupdate -radix binary /top_tb/DUT/IMM_GEN/immExt
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {59577 ps} 0}
...
update
WaveRestoreZoom {32879 ps} {61427 ps}
